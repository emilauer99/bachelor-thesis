...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? description = freezed,Object? state = null,Object? isPublic = null,Object? startDate = null,Object? endDate = null,Object? budget = freezed,Object? estimatedHours = freezed,Object? customer = null,Object? customerId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  String? description,  EProjectState state,  bool isPublic,  String startDate,  String endDate,  double? budget,  int? estimatedHours,  CustomerModel customer,  int? customerId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.state,_that.isPublic,_that.startDate,_that.endDate,_that.budget,_that.estimatedHours,_that.customer,_that.customerId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String name,  String? description,  EProjectState state,  bool isPublic,  String startDate,  String endDate,  double? budget,  int? estimatedHours,  CustomerModel customer,  int? customerId)  $default,) {final _that = this;
switch (_that) {
case _ProjectModel():
return $default(_that.id,_that.name,_that.description,_that.state,_that.isPublic,_that.startDate,_that.endDate,_that.budget,_that.estimatedHours,_that.customer,_that.customerId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String name,  String? description,  EProjectState state,  bool isPublic,  String startDate,  String endDate,  double? budget,  int? estimatedHours,  CustomerModel customer,  int? customerId)?  $default,) {final _that = this;
switch (_that) {
case _ProjectModel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.state,_that.isPublic,_that.startDate,_that.endDate,_that.budget,_that.estimatedHours,_that.customer,_that.customerId);case _:
  return null;
...
class _ProjectModel implements ProjectModel {
  const _ProjectModel({this.id, required this.name, this.description, required this.state, required this.isPublic, required this.startDate, required this.endDate, this.budget, this.estimatedHours, required this.customer, this.customerId});
...
/// Create a copy of ProjectModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? description = freezed,Object? state = null,Object? isPublic = null,Object? startDate = null,Object? endDate = null,Object? budget = freezed,Object? estimatedHours = freezed,Object? customer = null,Object? customerId = freezed,}) {
